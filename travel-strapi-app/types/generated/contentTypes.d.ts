...
export interface ApiBookTicketBookTicket extends Schema.CollectionType {
  ...
  attributes: {
    ...
    numberOfTickets: Attribute.Integer;
    travel_package: Attribute.Relation<
      'api::book-ticket.book-ticket',
      'manyToOne',
...
export interface ApiTravelPackageTravelPackage extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::travel-package.travel-package', 'title'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    book_tickets: Attribute.Relation<
      'api::travel-package.travel-package',
      'oneToMany',
      'api::book-ticket.book-ticket'
    >;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::book-ticket.book-ticket': ApiBookTicketBookTicket;
